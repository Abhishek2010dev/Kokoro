// Package kokoro provides core definitions and utilities for building HTTP services,
// including a comprehensive list of standard and extended HTTP header constants.
package kokoro
